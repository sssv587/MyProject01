...
//    int loop = 1;//控制是否退出菜单
//    char details[30000] = "-----------------当前收支明细记录-----------------\n收支\t收支金额\t账户金额   \t说  明";//记录所有的收入和支出情况
//    char note[20] = " "; //对收入或者支出的的说明
//    char temp[100] = " ";//用于格式化每次的收入或者支出，然后拼接到detail中去
//    double money = 0.0;
//    double balance = 1000.0;//账号余额，初始化为1000.0
//    char choice = ' ';//表示用户选择的是y还是n
//    int flag = 0;//表示是否有至少一比收入或支出
//
//    do {
//        printf("\n---------家庭收支记账软件---------");
//        printf("\n         1 收支明细");
